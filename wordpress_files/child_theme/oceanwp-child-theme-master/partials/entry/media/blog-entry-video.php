...
// Add images size based on blog style.
...
// Retrieve image alt text or use OceanWP default text if image alt text not set.
...
<div class="thumbnail">
    ...
    <a href="<?php the_permalink(); ?>" class="thumbnail-link">
        ...
        // If Ocean Extra plugin is active, resize the image.
        ...
        // Check if Ocean Extra plugin is active and if there is a custom size.
        if ( OCEAN_EXTRA_ACTIVE
