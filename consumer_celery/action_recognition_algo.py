...
def load_action_algo():
    ...
    try:
        # Hardcoded values
        config_path = '/home/dimineno/consumer_celery/action_paths/tsn_imagenet-pretrained-r50_8xb32-1x1x8-100e_kinetics400-rgb.py'
        checkpoint_path = '/home/dimineno/consumer_celery/action_paths/tsn_imagenet-pretrained-r50_8xb32-1x1x8-100e_kinetics400-rgb_20220906-2692d16c.pth'
        label_file = '/home/dimineno/consumer_celery/action_paths/label_map_k400.txt'
        out_file = '/home/dimineno/consumer_celery/action_paths/output.json'  
...
def action_algorithm(post_id, video_path, sample_length, input_step, out_file, threshold, stride, model, data, label, test_pipeline):
    ...
    try:
        ...
        # Find the most accurate action tagss
